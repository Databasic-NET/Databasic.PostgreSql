...
Public Class Statement
    ...
    Public Overrides Property Reader As DbDataReader
        ...
        End Set
    End Property
    Private _reader As NpgsqlDataReader
    ...
    Public Sub New(sql As String, connection As NpgsqlConnection)
        MyBase.New(sql, connection)
        Me._cmd = New NpgsqlCommand(sql, connection)
        'Me._cmd.Prepare()
    End Sub
    ''' <summary>
    ''' Empty SQL statement constructor.
    ...
    Public Sub New(sql As String, transaction As NpgsqlTransaction)
        MyBase.New(sql, transaction)
        Me._cmd = New NpgsqlCommand(sql, transaction.Connection, transaction)
        'Me._cmd.Prepare()
    End Sub
